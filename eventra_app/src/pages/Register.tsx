...
const Register: React.FC = () => {
  ...
  useEffect(() => {
    ...
    g.accounts.id.renderButton(googleBtnRef.current, { theme: 'outline', size: 'large', text: 'signup_with', width: googleBtnRef.current.clientWidth });
  }, [googleLoaded]);
      ...
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <div className="bg-linear-to-r from-primary-600 to-cyan-600 p-3 rounded-2xl shadow-lg">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-2">
            Join <span className="text-primary-600">Eventra</span>
          </h2>
        ...
        <div className="glass-effect rounded-2xl shadow-soft-xl p-8 border border-gray-100">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Google Sign-Up (only renders when VITE_GOOGLE_CLIENT_ID is set) */}
            {GOOGLE_CLIENT_ID && (
              <>
            ...
            <div className="text-center">
              <Link
                to="/login"
                className="font-medium text-primary-600 hover:text-primary-500 text-base"
              >
                Sign in instead →
              </Link>
            </div>
